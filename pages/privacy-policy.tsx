...
const PrivacyPolicy = () => {
  return (
    <div className="flex flex-col space-y-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named DBS
            Tyres
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to DBS Automotive, 34/138 H, NH Bye Pass,
        ...
        <li>
          <p>
            <strong>Website</strong> refers to DBS Tyres, accessible from{" "}
            <a
              href="www.dbstyres.com"
      ...
      <ul>
        <li>By email: hello@dbstyres.com</li>
      </ul>
    </div>
  );
};
