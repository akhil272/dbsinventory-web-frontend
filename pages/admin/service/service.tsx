import { ServiceProps } from "@Store/quotations/types";
import Link from "next/link";
import React, { useEffect, useState } from "react";

const Service = ({ services, getServices }: ServiceProps) => {
  ...
  const filtered = services?.filter((serviceItem) =>
    serviceItem.name
      .toLowerCase()
      .replace(/\s+/g, "")
