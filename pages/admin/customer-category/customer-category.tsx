import { CustomerCategoryProps } from "@Store/customers/types";
...
const CustomerCategory = ({
  ...
  const filtered = customerCategories?.filter((customerCategory) =>
  ...
  return (
    <div>
      ...
      <div className="w-full flex pt-1 justify-end">
        <Link href="/admin/customer-category/create">
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {filtered?.map((customerCategory, index) => (
              <tr
              ...
              >
                ...
                <td className="px-6 py-4">{customerCategory.name}</td>

                <td className="px-6 py-4 text-right">
                  <Link
                    href={{
                      pathname: "/admin/customer-category/update",
                      query: {
                        customerCategoryId: customerCategory.id,
                        customerCategoryName: customerCategory.name,
                      },
                    }}
                  >
                ...
                <td className="px-6 py-4 text-right">
                  <Link
                    href={{
                      pathname: "/admin/customer-category/delete",
                      query: {
                        customerCategoryId: customerCategory.id,
                        customerCategoryName: customerCategory.name,
                      },
