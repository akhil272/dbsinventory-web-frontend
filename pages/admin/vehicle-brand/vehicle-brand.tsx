import { VehicleBrandProps } from "@Store/adminPanel/types";
...
const VehicleBrand = ({
  ...
  const filtered = vehicleBrands?.filter((vehicleBrand) =>
  ...
  return (
    <div>
      ...
      <div className="w-full flex pt-1 justify-end">
        <Link href="/admin/vehicle-brand/create">
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {filtered?.map((vehicleBrand, index) => (
              <tr
                key={vehicleBrand.id}
              ...
              >
                ...
                <td className="px-6 py-4">{vehicleBrand.vehicleBrand}</td>

                <td className="px-6 py-4 text-right">
                  <Link
                    href={{
                      pathname: "/admin/vehicle-brand/update",
                      query: {
                ...
                <td className="px-6 py-4 text-right">
                  <Link
                    href={{
                      pathname: "/admin/vehicle-brand/delete",
                      query: {
                        vehicleBrandId: vehicleBrand.id,
                        vehicleBrand: vehicleBrand.vehicleBrand,
                      },
