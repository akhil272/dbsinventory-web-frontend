import { TransportProps } from "@Store/adminPanel/types";
import Link from "next/link";
import React, { useEffect, useState } from "react";

const Transport = ({ getTransports, transports }: TransportProps) => {
  ...
  return (
    <div>
      ...
      <div className="w-full flex pt-1 justify-end">
        <Link href="/admin/transport/create">
          ...
          <tbody>
            {filtered?.map((transport, index) => (
              ...
              >
                ...
                <td className="px-6 py-4">{transport.mode}</td>

                <td className="px-6 py-4 text-right">
                  <Link
                    href={{
                      pathname: "/admin/transport/update",
                      query: {
                ...
                <td className="px-6 py-4 text-right">
                  <Link
                    href={{
                      pathname: "/admin/transport/delete",
                      query: {
                        transportId: transport.id,
                        transportMode: transport.mode,
                      },
