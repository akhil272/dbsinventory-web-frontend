import { VehicleModelProps } from "@Store/adminPanel/types";
...
const VehicleModel = ({
  ...
  const filtered = vehicleModels?.filter((vehicleModel) =>
    vehicleModel.model
      .toLowerCase()
      .replace(/\s+/g, "")
  ...
  return (
    <div>
      ...
      <div className="w-full flex pt-1 justify-end">
        <Link href="/admin/vehicle-model/create">
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {filtered?.map((vehicleModel, index) => (
              <tr
                key={vehicleModel.id}
              ...
              >
                ...
                <td className="px-6 py-4">{vehicleModel.model}</td>
                ...
                <td className="px-6 py-4 text-right">
                  <Link
                    href={{
                      pathname: "/admin/vehicle-model/update",
                      query: {
                ...
                <td className="px-6 py-4 text-right">
                  <Link
                    href={{
                      pathname: "/admin/vehicle-model/delete",
                      query: {
                        vehicleModelId: vehicleModel.id,
                        vehicleModel: vehicleModel.model,
                      },
